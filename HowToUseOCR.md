...
This document provides instructions on how to add additional language packs for the OCR tab in RyanPDF, both inside and outside of Docker.
...
RyanPDF uses Tesseract for its text recognition. All credit goes to them for this awesome work!
...
Depending on your requirements, you can choose the appropriate language pack for your use case. By default, RyanPDF uses `tessdata_fast` for English, but this can be replaced.
