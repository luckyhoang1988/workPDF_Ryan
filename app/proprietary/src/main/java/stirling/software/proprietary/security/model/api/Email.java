...
public class Email extends GeneralFile {
    ...
    @Schema(
            ...
            defaultValue = "RyanPDF Notification",
    ...
    @Schema(
            ...
            requiredMode = Schema.RequiredMode.NOT_REQUIRED,
            defaultValue =
                    "This message was automatically generated by RyanPDF, an innovative"
                            + " PDF solution.<br><br>Please do not reply directly to this"
                            + " email.")
    private String body;
}
