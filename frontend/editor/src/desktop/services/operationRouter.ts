          ...
          if (!supportedLocally) {
            ...
            throw new Error(
              i18n.t(
                ...
                "This tool requires an account. Sign in to RyanPDF Cloud or connect to a self-hosted server to use it.",
              ),
            );
          }
        }
      ...
      if (status === "offline") {
        ...
        throw new Error(
          i18n.t(
            ...
            'Your RyanPDF server is offline and "{{endpoint}}" is not available on the local backend.',
