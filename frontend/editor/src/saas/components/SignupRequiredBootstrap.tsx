      ...
      <Stack gap="md">
        <Text>
          {t(
            ...
            "RyanPDF gives every signed-up account 500 free operations — enough to keep most workflows humming without paying a cent. You're currently using RyanPDF as a guest, which doesn't include billable tools like AI, automations, or hosted processing.",
          )}
        </Text>
