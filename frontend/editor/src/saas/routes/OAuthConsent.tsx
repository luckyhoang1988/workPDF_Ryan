...
export default function OAuthConsent() {
  ...
  useDocumentMeta({
    title: `${t("oauthConsent.title", "Authorize access")} - RyanPDF`,
  });
      ...
      <AuthLayout>
        ...
        >
          {t(
            ...
            "Sign in to your RyanPDF account to continue connecting the app.",
          )}
        </p>
        <Button
          variant="secondary"
    ...
    <AuthLayout>
      ...
      >
        {t("oauthConsent.requesting", {
          app: appName,
          defaultValue: `${appName} wants to access your RyanPDF account`,
        })}
      </p>
      ...
      {/* Be explicit about what connecting actually grants. The OAuth scopes
          ...
          token lets the app drive the MCP endpoint - i.e. run any RyanPDF
        ...
        >
          <li style={{ fontSize: "0.875rem", color: "#374151" }}>
            {t("oauthConsent.access.tools", {
              app: appName,
              defaultValue: `Use your RyanPDF tools on your behalf - convert, edit, sign, secure and process your documents`,
            })}
          </li>
          <li style={{ fontSize: "0.875rem", color: "#374151" }}>
