...
export function GettingStartedSection({
  ...
  return (
    <DocsSection
      id="quickstart"
      eyebrow={t("portal.docs.quickstart.eyebrow")}
      title={t("portal.docs.quickstart.title")}
      lead={t("portal.docs.quickstart.lead")}
    >
      <ol className="portal-docs__steps">
        ...
        <li className="portal-docs__step">
          ...
          <div className="portal-docs__step-body">
            ...
            <LangSnippet
              samples={samples}
              caption={t("portal.docs.quickstart.step2.snippetCaption")}
            />
          </div>
        </li>
        <li className="portal-docs__step">
          ...
          <div className="portal-docs__step-body">
            ...
            <CodeBlock
              lang="json"
              code={response}
              caption={t("portal.docs.quickstart.step3.codeCaption")}
            />
          </div>
        </li>
      </ol>
      ...
      <Card className="portal-docs__callout" accent="default" padding="loose">
        ...
        {t("portal.docs.quickstart.callout.bodyAfterLink")}
      </Card>
    </DocsSection>
  );
}
