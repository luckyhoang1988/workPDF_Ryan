...
const AdminOverviewBody: React.FC<{
  ...
  const defaultValue = loginEnabled
    ? "As an admin, you can manage users, configure settings, and monitor server health. The first <strong>{{freeTierLimit}}</strong> people on your server get to use RyanPDF free of charge."
    : "Once you enable login mode, you can manage users, configure settings, and monitor server health. The first <strong>{{freeTierLimit}}</strong> people on your server get to use RyanPDF free of charge.";
