        ...
        <div>
          ...
          <Text size="sm" c="dimmed">
            {t(
              ...
              "Expose RyanPDF's PDF tools and AI agents to MCP clients over an OAuth-protected endpoint.",
            )}
          </Text>
        </div>
          ...
          <Stack gap="md">
            ...
            <Select
              ...
              description={t(
                ...
                "OAuth needs an external IdP. API key uses a RyanPDF per-user API key (X-API-KEY) - simplest for self-host.",
              )}
              data={[
                { value: "oauth", label: "OAuth 2.1 (external IdP)" },
                { value: "apikey", label: "API key (RyanPDF per-user key)" },
              ]}
              value={authMode}
              ...
              <Alert variant="light" color="gray">
                <Text size="xs">
                  {t(
                    ...
                    "Clients send a RyanPDF API key in the X-API-KEY header (or Authorization: Bearer <key>). The key maps to its owning RyanPDF user - only provisioned accounts get in, and actions are audited as that user. Manage keys under Account → API Keys.",
                  )}
                </Text>
              </Alert>
            )}
              ...
              <>
                  ...
                  <div>
                    <Text fw={500} size="sm">
                      {t(
                        ...
                        "Require an existing RyanPDF account",
                      )}
                    </Text>
                    <Text size="xs" c="dimmed" mt={4}>
                      {t(
                        "admin.settings.mcp.requireAccount.description",
                        "Only let tokens through if their subject maps to a provisioned, enabled RyanPDF user.",
                      )}
                    </Text>
                  </div>
                  <Group gap="xs">
                ...
                <TextInput
                  ...
                  description={t(
                    ...
                    "JWT claim matched against a RyanPDF username (e.g. sub, email, preferred_username).",
                  )}
            ...
            <Text size="xs" c="dimmed">
              {authMode === "oauth"
                ...
                : t(
                    ...
                    "Tip: API-key mode needs no external IdP - simplest for self-host. The key maps to its owning RyanPDF user.",
                  )}
            </Text>
          </Stack>
        </Alert>
