...
const AccountSection: React.FC = () => {
  ...
  const qrLogoSrc = `${BASE_PATH}/modern-logo/RyanPDFLogoNoTextDark.svg`;
      ...
      >
        <form onSubmit={handleEnableMfa}>
          <Stack gap="md">
            ...
            />
            <Group justify="flex-end" gap="sm">
              <Button variant="secondary" onClick={handleCloseMfaSetupModal}>
                {t("common.cancel", "Cancel")}
              </Button>
      ...
      >
        <form onSubmit={handleDisableMfa}>
          <Stack gap="md">
            ...
            />
            <Group justify="flex-end" gap="sm">
              <Button variant="secondary" onClick={handleCloseMfaDisableModal}>
                {t("common.cancel", "Cancel")}
              </Button>
