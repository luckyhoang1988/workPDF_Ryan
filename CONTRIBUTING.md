# Contributing to RyanPDF

Thank you for your interest in contributing to RyanPDF! There are many ways to contribute other than writing code. For example, reporting bugs, creating suggestions, and adding or modifying translations.
...
If you would like to add or modify a translation, please see [How to add new languages to RyanPDF](devGuide/HowToAddNewLanguage.md). Also, please create a Pull Request so others can use it!
